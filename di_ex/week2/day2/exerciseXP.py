...
# def check_random(integer):
#     if integer in range(1, 101):
#         gen_number = rnd.randint(1, 100)

#         if gen_number == integer:
#             return "Success!"
#         else:
#             return "Fail!"
#     else:
#         return "You did not input a parameter between 1 and 100"


# print(check_random(25))
...
# Modify the make_shirt() function so that size has a default value of “large” and text has a
# default value of “I love Python”.
...
# make_shirt()
# make_shirt("medium")
# make_shirt("small", "Who are you?")
# make_shirt(size="small", text="Why are we here?")
...
# Inside the function, use a for loop to iterate through the list and add “the Great” before each
# magician’s name.
...
# magician_list = ["Harry Houdini", "David Blaine", "Criss Angel"]
...
#         list[index] = f"The Great {magician}"
#     return list
...
# Create a function called get_random_temp() that returns a random integer between -10 and 40 degrees
# Celsius.
...
# def get_random_temp():
#     return rnd.uniform(-10, 40)


# def main():
#     selected_temp = get_random_temp()
#     print(f"The temperature right now is {selected_temp} degrees Celsius.")
#     if selected_temp < 0:
#         return "Brrr, that’s freezing! Wear some extra layers today."
#     elif selected_temp >= 0 and selected_temp < 16:
#         return "Quite chilly! Don’t forget your coat."
#     elif selected_temp >= 16 and selected_temp < 24:
#         return "Nice weather."
#     elif selected_temp >= 24 and selected_temp < 32:
...
# Instead of directly generating a random temperature, ask the user for a month (1-12) and determine
# the season using if/elif conditions.
...
# while True:
#     try:
#         user_month = input("Give me a month between 1 and 12\n")
#         if int(user_month) < 1 or int(user_month) > 12:
#             print("There is no such month")
#         else:
#             break
#     except ValueError as ve:
#         print("You did not give me a month")


# def get_month_temp(month):
#     try:
#         if int(month) in range(3, 6):
#             return rnd.randint(12, 24)
#         elif int(month) in range(6, 9):
#             return rnd.randint(17, 36)
#         elif int(month) in range(9, 12):
#             return rnd.randint(8, 18)
#         else:
...
# def main():
#     selected_temp = get_month_temp(user_month)
#     print(f"The temperature right now is {selected_temp} degrees Celsius.")
#     if selected_temp < 0:
#         return "Brrr, that’s freezing! Wear some extra layers today."
#     elif selected_temp >= 0 and selected_temp < 16:
