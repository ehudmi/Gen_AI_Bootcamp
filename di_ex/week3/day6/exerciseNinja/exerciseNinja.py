...
# Create a new list of special Valentine’s day items inside the json file. For now the list should
# be empty.

# Ask to the manager for a new Valentine item to add, if the item is correct (ie. follows the rules
# below), then add it to the list inside the json file.
# Each word in the item name should begin with an uppercase letter and because it’s Valentines Day,
...
# These six abilities have scores that are determined randomly. You do this by rolling four 6-sided
...
# Hint: the Character class should be in charge of creating characters, the Game class should be in
# charge of how many times the Character gets instantiated and of exporting the data in json or txt
