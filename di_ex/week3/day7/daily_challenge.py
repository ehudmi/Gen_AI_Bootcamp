...
# id (int)
# current_location : The Airport where the airplane is currently located (see below the Airport
# class)
# company : The airline this airplane belongs to (see above the Airline class)
# next_flights : The list of Flights. Every future flights of the airplane, this list should
# always be sorted by datetime. (see below the Flight class)
...
# on this date (it can fly if it is in this location on this date and if it doesn’t already have
# a flight planned).
...
# id (str) : The ID is an encoded string composed of the destination, the airlines code and the
# date.
# Methods:
...
# scheduled_arrivals : The list of flight - Every future flight that will arrive to this airport,
# sorted by date. (see above the Flight class)
...
# You are free to add any class/method/attribute to your code, be sure to document everything you
# write.
