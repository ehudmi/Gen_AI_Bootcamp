...
# Rock-paper-scissors is an old game that can be played between two people. You can read about it in
# wikipedia
...
# We will then compare the user’s move with the computer’s move, and determine the results of the
# game:
...
# The user will be able to play again and again. Once the user decides to exit the program, we will
# print a summary of the outcomes of all the games: how many times they won, lost or and tied the computer.
...
# get_user_item(self) – Ask the user to select an item (rock/paper/scissors). Keep asking until the
# user has selected one of the items – use data validation and looping. Return the item at the end
# of the function.

# get_computer_item(self) – Select rock/paper/scissors at random for the computer. Return the item
# at the end of the function. Use python’s random.choice() function (read about it online).
...
# Print the output of the game; something like this: “You selected rock. The computer selected
# paper. You lose”, “You selected scissors. The computer selected scissors. You drew!”
