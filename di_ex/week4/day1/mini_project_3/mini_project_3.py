...
# The current weather data can be retrieved from OpenWeatherMap using the Observation module in
...
# Recreate these steps, but this time, ask the user for a location (display the information in a
# user friendly way).
...
# Retrieve weather forecasts : The OpenWeatherMap free tier gives you access to 5 day forecasts.
...
# Forecasts are useful if you want to know what the weather conditions will be throughout the
# day/week.

# Use this API to retrieve the Air Pollution in a specific city.
# Mini project : XP Ninja
# BONUS: Your goal is to produce a weather GUI that shows the three-day humidity forecast for a
# city of your choice.
# If you’ve never built a GUI with Python, don’t worry! We’ll be going through step by step how to
# build it. We will be using Matplotlib to
