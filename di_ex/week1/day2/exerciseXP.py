...
# print(f"My computer is a {computer_brand} computer")
...
#     if int(user_num) % 2 == 0
#     else print("the number you chose is odd")
# )
...
#     else print("Wow...we must be from different universes - we have the same name")
# )
